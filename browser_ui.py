...
"background:transparent")
        ...
        self.pushButton_home.setMaximumSize(QtCore.QSize(25, 16777215))
...
"color:rgb(144,144,144);")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_home.setText(_translate("Form", "⌂"))
        ...
        self.label.setText(_translate("Form", "Developed by Queeenace. v 1.0"))
